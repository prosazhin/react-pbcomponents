...
function yr() {
  if (ke)
    return I;
  ke = 1;
  var a = Fe, i = Symbol.for("react.element"), s = Symbol.for("react.fragment"), o = Object.prototype.hasOwnProperty, c = a.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner, m = { key: !0, ref: !0, __self: !0, __source: !0 };
  function x(p, d, w) {
    var E, y = {}, C = null, T = null;
    w !== void 0 && (C = "" + w), d.key !== void 0 && (C = "" + d.key), d.ref !== void 0 && (T = d.ref);
    for (E in d)
      o.call(d, E) && !m.hasOwnProperty(E) && (y[E] = d[E]);
    if (p && p.defaultProps)
      for (E in d = p.defaultProps, d)
        y[E] === void 0 && (y[E] = d[E]);
    return { $$typeof: i, type: p, key: C, ref: T, props: y, _owner: c.current };
  }
  return I.Fragment = s, I.jsx = x, I.jsxs = x, I;
}
var Y = {};
/**
 * @license React
...
function Er() {
  return Ae || (Ae = 1, process.env.NODE_ENV !== "production" && function() {
    var a = Fe, i = Symbol.for("react.element"), s = Symbol.for("react.portal"), o = Symbol.for("react.fragment"), c = Symbol.for("react.strict_mode"), m = Symbol.for("react.profiler"), x = Symbol.for("react.provider"), p = Symbol.for("react.context"), d = Symbol.for("react.forward_ref"), w = Symbol.for("react.suspense"), E = Symbol.for("react.suspense_list"), y = Symbol.for("react.memo"), C = Symbol.for("react.lazy"), T = Symbol.for("react.offscreen"), A = Symbol.iterator, Ye = "@@iterator";
    function ze(e) {
    ...
    function Je(e) {
      return !!(typeof e == "string" || typeof e == "function" || e === o || e === m || qe || e === c || e === w || e === E || Be || e === T || Le || Me || Ue || typeof e == "object" && e !== null && (e.$$typeof === C || e.$$typeof === y || e.$$typeof === x || e.$$typeof === p || e.$$typeof === d || // This needs to include all possible module reference object
    ...
    function P(e) {
      ...
      if (typeof e == "object")
        switch (e.$$typeof) {
          ...
          case C: {
            var f = e, b = f._payload, u = f._init;
            try {
              return P(u(b));
            } catch {
              return null;
...
`), _ = n.stack.split(`
`), v = l.length - 1, h = _.length - 1; v >= 1 && h >= 0 && l[v] !== _[h]; )
            h--;
          for (; v >= 1 && h >= 0; v--, h--)
            if (l[v] !== _[h]) {
              if (v !== 1 || h !== 1)
...
` + l[v].replace(" at new ", " at ");
        ...
        X = !1, H.current = b, Ke(), Error.prepareStackTrace = f;
      }
      var $ = e ? e.displayName || e.name : "", Se = $ ? V($) : "";
    ...
    var U = Object.prototype.hasOwnProperty, he = {}, xe = D.ReactDebugCurrentFrame;
    function B(e) {
      if (e) {
    ...
    function er(e, r, t, n, f) {
      {
        ...
        for (var u in e)
          if (b(e, u)) {
            ...
            l && !(l instanceof Error) && (B(f), R("%s: type specification of %s `%s` is invalid; the type checker function must return `null` or an `Error` but returned a %s. You may have forgotten to pass an argument to the type checker creator (arrayOf, instanceOf, objectOf, oneOf, oneOfType, and shape all require an argument).", n || "React class", t, u, typeof l), B(null)), l instanceof Error && !(l.message in he) && (he[l.message] = !0, B(f), R("Failed %s type: %s", t, l.message), B(null));
          }
      }
    }
    ...
    function fr(e, r, t, n, f) {
      {
        var b, u = {}, l = null, _ = null;
        t !== void 0 && (Ee(t), l = "" + t), ir(r) && (Ee(r.key), l = "" + r.key), or(r) && (_ = r.ref, sr(r, f));
        for (b in r)
          U.call(r, b) && !nr.hasOwnProperty(b) && (u[b] = r[b]);
        if (e && e.defaultProps) {
        ...
        return cr(e, l, _, f, n, W.current, u);
      }
    }
    var ee = D.ReactCurrentOwner, _e = D.ReactDebugCurrentFrame;
    function F(e) {
      if (e) {
        var r = e._owner, t = M(e.type, e._source, r ? r.type : null);
...
Check the top-level render call using <` + t + ">.");
    ...
    function Oe(e, r) {
      {
        ...
        if (Z(e))
          ...
          if (typeof f == "function" && f !== e.entries)
            for (var b = f.call(e), u; !(u = b.next()).done; )
              te(u.value) && Ce(u.value, r);
        }
      }
    }
    function pr(e) {
    ...
    var hr = gr, xr = vr;
    Y.Fragment = o, Y.jsx = hr, Y.jsxs = xr;
  }()), Y;
}
...
function O() {
  for (var a, i, s = 0, o = "", c = arguments.length; s < c; s++)
...
const De = {
...
}, wr = ({ children: a, className: i, size: s, medium: o }) => /* @__PURE__ */ g.jsx("span", { className: O("text-inherit", o ? De[s].m : De[s].r, i), children: a }), ae = {
  s: {
    size: 16,
    class: "size-[16px]"
  },
...
}, G = ({ className: a, name: i, size: s }) => /* @__PURE__ */ g.jsx(
  i,
  {
    width: ae[s].size,
    height: ae[s].size,
    className: O("text-inherit bg-transparent", ae[s].class, a)
  }
), Rr = {
  s: "space-x-[6px]",
  m: "space-x-[8px]",
  l: "space-x-[12px]"
}, z = ({ children: a, className: i, leftIcon: s, rightIcon: o, size: c, medium: m }) => /* @__PURE__ */ g.jsxs("span", { className: O("inline-flex w-max flex-nowrap items-center", Rr[c], i), children: [
  s && /* @__PURE__ */ g.jsx(G, { name: s, size: c }),
  a && /* @__PURE__ */ g.jsx(wr, { size: c, medium: m, children: a }),
  o && a && /* @__PURE__ */ g.jsx(G, { name: o, size: c })
] }), _r = {
  s: "space-x-[6px]",
  m: "space-x-[8px]"
}, Fr = ({ as: a = "button", isActive: i, size: s, children: o, className: c, ...m }) => /* @__PURE__ */ g.jsx(
  a,
  {
    className: O(
      ...
      i ? "text-primary-main hover:bg-white" : "text-basic-main",
      c,
      _r[s]
    ),
    ...m,
    children: /* @__PURE__ */ g.jsx(z, { size: s, medium: !0, children: o })
  }
), Tr = ({
  children: a,
  className: i,
  ...
  const { href: x, disabled: p } = m, d = x ? "a" : "button";
  return /* @__PURE__ */ g.jsx(
    d,
    {
      className: O(
        ...
        c && "text-primary-main after:bg-primary-main",
...
function jr({
  ...
  return /* @__PURE__ */ J.createElement("svg", Object.assign({
    ...
    ref: o,
    "aria-labelledby": i
  }, s), a ? /* @__PURE__ */ J.createElement("title", {
    id: i
...
const Cr = J.forwardRef(jr), Ie = Cr, Or = {
  ...
  const [w, E] = ie(0), y = $e(null), { href: C, disabled: T } = d, A = C ? "a" : "button";
  return Ne(() => {
    y && y.current && E(y.current.offsetWidth);
  }, [a, c, s, o]), /* @__PURE__ */ g.jsx(
    A,
    {
      className: O(
        ...
        T && !p ? `${ne[m].disabled} !cursor-not-allowed` : ne[m][x],
        i
      ),
      disabled: T || p,
      "aria-disabled": T || p,
      ...
      ...d,
      children: p ? /* @__PURE__ */ g.jsx(
        G,
        {
          name: Ie,
          size: c === "xs" ? "s" : c,
          className: O(ne[m][x], "animate-spin transition")
        }
      ) : /* @__PURE__ */ g.jsx(z, { size: c === "xs" ? "s" : c, leftIcon: s, rightIcon: o, medium: !0, children: a })
    }
  );
}, Pr = {
  s: "py-[4px] px-[8px]",
  ...
  return Ne(() => {
    ...
    A,
    {
      className: O(
        ...
        Pr[m],
        !c && x === "border" && "before:border",
        c ? T && !p ? `${q.light.disabled} !cursor-not-allowed` : q[x].checked : T && !p ? `${q[x].disabled} !cursor-not-allowed` : q[x].default,
        i
      ),
      disabled: T || p,
      "aria-disabled": T || p,
      ...
      style: { width: p ? w : void 0 },
      ...d,
      children: p ? /* @__PURE__ */ g.jsx(G, { name: Ie, size: "s", className: "transition animate-spin" }) : /* @__PURE__ */ g.jsx(z, { size: "s", leftIcon: s, rightIcon: o, medium: !0, children: a })
    }
  );
}, Sr = {
  s: "py-[4px] px-[8px]",
...
}, Wr = ({ children: a, className: i, leftIcon: s, rightIcon: o, size: c, theme: m, color: x }) => /* @__PURE__ */ g.jsx(
  "span",
  {
    className: O(
    ...
    children: /* @__PURE__ */ g.jsx(z, { size: "s", leftIcon: s, rightIcon: o, medium: !0, children: a })
  }
), Ar = (a, i) => typeof i == "function" ? i(a) : typeof i < "u" ? a[i] : a, Ir = ({ className: a, defaultIndex: i = 0, options: s, display: o, onChange: c }) => {
  const [m, x] = ie(i), p = (d, w) => {
    x(d), c(d, w);
  };
  return /* @__PURE__ */ g.jsx(
    "div",
    {
      ...
      children: /* @__PURE__ */ g.jsx("div", { className: "flex flex-row space-x-[16px] z-[2] relative flex-nowrap items-center w-auto overflow-x-auto scrollbar-hidden", children: s.map((d, w) => /* @__PURE__ */ g.jsx(Tr, { ...d, active: m === w, onClick: () => p(w, d), children: Ar(d, o) }, w)) })
    }
  );
};
export {

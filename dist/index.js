...
function lr() {
  if (Te)
    return I;
  Te = 1;
  var f = Ce, c = Symbol.for("react.element"), g = Symbol.for("react.fragment"), h = Object.prototype.hasOwnProperty, O = f.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner, C = { key: !0, ref: !0, __self: !0, __source: !0 };
  function A(w, d, S) {
    var m, b = {}, T = null, M = null;
    S !== void 0 && (T = "" + S), d.key !== void 0 && (T = "" + d.key), d.ref !== void 0 && (M = d.ref);
    for (m in d)
      h.call(d, m) && !C.hasOwnProperty(m) && (b[m] = d[m]);
    if (w && w.defaultProps)
      for (m in d = w.defaultProps, d)
        b[m] === void 0 && (b[m] = d[m]);
    return { $$typeof: c, type: w, key: T, ref: M, props: b, _owner: O.current };
  }
  return I.Fragment = g, I.jsx = A, I.jsxs = A, I;
}
var L = {};
/**
 * @license React
...
function fr() {
  return xe || (xe = 1, process.env.NODE_ENV !== "production" && function() {
    var f = Ce, c = Symbol.for("react.element"), g = Symbol.for("react.portal"), h = Symbol.for("react.fragment"), O = Symbol.for("react.strict_mode"), C = Symbol.for("react.profiler"), A = Symbol.for("react.provider"), w = Symbol.for("react.context"), d = Symbol.for("react.forward_ref"), S = Symbol.for("react.suspense"), m = Symbol.for("react.suspense_list"), b = Symbol.for("react.memo"), T = Symbol.for("react.lazy"), M = Symbol.for("react.offscreen"), Q = Symbol.iterator, Se = "@@iterator";
    function Pe(e) {
    ...
    function Ie(e) {
      return !!(typeof e == "string" || typeof e == "function" || e === h || e === C || $e || e === O || e === S || e === m || De || e === M || ke || Fe || Ae || typeof e == "object" && e !== null && (e.$$typeof === T || e.$$typeof === b || e.$$typeof === A || e.$$typeof === w || e.$$typeof === d || // This needs to include all possible module reference object
    ...
    var x = Object.assign, D = 0, te, ne, ae, oe, ie, ue, se;
    function le() {
    }
...
` + a[s].replace(" at new ", " at ");
    ...
    var V = Object.prototype.hasOwnProperty, ce = {}, de = P.ReactDebugCurrentFrame;
    function U(e) {
      if (e) {
    ...
    function Ue(e, r, t, n, i) {
      {
        ...
        for (var o in e)
          if (u(e, o)) {
            ...
            a && !(a instanceof Error) && (U(i), v("%s: type specification of %s `%s` is invalid; the type checker function must return `null` or an `Error` but returned a %s. You may have forgotten to pass an argument to the type checker creator (arrayOf, instanceOf, objectOf, oneOf, oneOfType, and shape all require an argument).", n || "React class", t, o, typeof a), U(null)), a instanceof Error && !(a.message in ce) && (ce[a.message] = !0, U(i), v("Failed %s type: %s", t, a.message), U(null));
          }
      }
    }
    ...
    function Ke(e, r) {
      if (typeof e.ref == "string" && $.current && r && $.current.stateNode !== r) {
        ...
        H[t] || (v('Component "%s" contains the string ref "%s". Support for string refs will be removed in a future major release. This case cannot be automatically converted to an arrow function. We ask you to manually fix this case by using useRef() or createRef() instead. Learn more about using refs safely here: https://reactjs.org/link/strict-mode-string-ref', E($.current.type), e.ref), H[t] = !0);
      }
    }
    function Xe(e, r) {
      {
    ...
    function er(e, r, t, n, i) {
      {
        ...
        t !== void 0 && (pe(t), a = "" + t), ze(r) && (pe(r.key), a = "" + r.key), He(r) && (p = r.ref, Ke(r, i));
        for (u in r)
...
Check the top-level render call using <` + t + ">.");
    ...
    function Ee(e, r) {
      {
        ...
        be[t] = !0;
        var n = "";
        e && e._owner && e._owner !== z.current && (n = " It was passed a child from " + E(e._owner.type) + "."), j(e), v('Each child in a list should have a unique "key" prop.%s%s See https://reactjs.org/link/warning-keys for more information.', t, n), j(null);
      }
    }
    function ye(e, r) {
      {
    ...
    function _e(e, r, t, n, i, u) {
      {
        ...
        if (!o) {
          ...
          p ? a += p : a += Re();
          var s;
          e === null ? s = "null" : G(e) ? s = "array" : e !== void 0 && e.$$typeof === c ? (s = "<" + (E(e.type) || "Unknown") + " />", a = " Did you accidentally export a JSX literal instead of a component?") : s = typeof e, v("React.jsx: type is invalid -- expected a string (for built-in components) or a class/function (for composite components) but got: %s.%s", s, a);
        }
        var l = er(e, r, t, i, u);
        if (l == null)
          return l;
    ...
    var ur = ir, sr = or;
    L.Fragment = h, L.jsx = ur, L.jsxs = sr;
  }()), L;
}
process.env.NODE_ENV === "production" ? Z.exports = lr() : Z.exports = fr();
var F = Z.exports;
const Er = ({ label: f }) => /* @__PURE__ */ F.jsx("button", { className: "rounded-full bg-primary-main px-8 py-2 text-white", children: f }), cr = {
  SR: "t4",
  SM: "tm4",
  MR: "t3",
  MM: "tm3",
  LR: "h4",
  LM: "tm2"
}, dr = ({ size: f, color: c, label: g }) => /* @__PURE__ */ F.jsx("p", { className: `${c} text-${cr[f]}`, children: g });
function vr({
  title: f,
  titleId: c,
  ...g
  ...
  return /* @__PURE__ */ _.createElement("svg", Object.assign({
    ...
    ref: h,
    "aria-labelledby": c
  }, g), f ? /* @__PURE__ */ _.createElement("title", {
    id: c
  }, f) : null, /* @__PURE__ */ _.createElement("path", {
    fillRule: "evenodd",
    d: "M7.28 7.72a.75.75 0 010 1.06l-2.47 2.47H21a.75.75 0 010 1.5H4.81l2.47 2.47a.75.75 0 11-1.06 1.06l-3.75-3.75a.75.75 0 010-1.06l3.75-3.75a.75.75 0 011.06 0z",
    clipRule: "evenodd"
  }));
}
const pr = _.forwardRef(vr), gr = pr;
function mr({
  title: f,
  titleId: c,
  ...g
...
const hr = _.forwardRef(mr), Rr = hr, Oe = {
  S: "h-4 w-4",
  M: "h-6 w-6",
  L: "h-7 w-7"
